namespace Common.Constans
{
    ...
    enum UnitFields
    {
        ...
        UINT_FIELD_BASESTAT0                  = 0x22,
        UINT_FIELD_BASESTAT1                  = 0x23,
        UINT_FIELD_BASESTAT2                  = 0x24,
        UINT_FIELD_BASESTAT3                  = 0x25,
        UINT_FIELD_BASESTAT4                  = 0x26,
    ...
    enum PlayerFields
    {
        ...
        PLAYER_SELECTION            = 0x8A,
        PLAYER_FARSIGHT             = 0x8C,
        PLAYER_DUEL_ARBITER         = 0x8E,
    ...
    enum CorpseFields
    {
        ...
        CORPSE_FIELD_FACING     = 0x2,
        CORPSE_FIELD_POS_X      = 0x3,
        CORPSE_FIELD_POS_Y      = 0x4,
        CORPSE_FIELD_POS_Z      = 0x5,
        CORPSE_FIELD_DISPLAY_ID = 0x6,
        CORPSE_FIELD_ITEM       = 0x7,
        CORPSE_FIELD_BYTES_1    = 0x1A,
        CORPSE_FIELD_BYTES_2    = 0x1B,
        CORPSE_FIELD_GUILD      = 0x1C,
        CORPSE_FIELD_LEVEL      = 0x1D
    };
}
