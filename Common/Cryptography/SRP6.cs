...
namespace Common.Cryptography
{
    public class SRP6
    {
        ...
        public SRP6()
        {
            this.N = new byte[] { 0x89, 0x4b, 100, 0x5e, 0x89, 0xe1, 0x53, 0x5b, 0xbd, 0xad, 0x5b, 0x8b, 0x29, 6, 80, 0x53,
                             8, 1, 0xb1, 0x8e, 0xbf, 0xbf, 0x5e, 0x8f, 0xab, 60, 130, 0x87, 0x2a, 0x3e, 0x9b, 0xb7 };

            this.salt = new byte[] { 0xad, 0xd0, 0x3a, 0x31, 210, 0x71, 20, 70, 0x75, 0xf2, 0x70, 0x7e, 80, 0x26, 0xb6, 210,
                                0xf1, 0x86, 0x59, 0x99, 0x76, 2, 80, 170, 0xb9, 0x45, 0xe0, 0x9e, 0xdd, 0x2a, 0xa3, 0x45 };

            this.k = new byte[] { 3 };
            this.B = new byte[0x20];
            this.b = new byte[20];
        }
